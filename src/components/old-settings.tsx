...
export class Settings extends Component<IProps, {}> {
  ...
  onEnigmaTypeSelect = (event: any) => {
    this.props.store.enigmaModel = event.value;
  };
  ...
  onSettingsLock = (_e: any) => {
    ...
    this.props.store.settingsAreLocked = !this.props.store.settingsAreLocked;
  };
    ...
    return (
      <div className="settings">
        ...
        <RotorSetting
          ...
          store={this.props.store}
        />
        {this.props.store.enigmaModel === "M4" ? (
          <>
            <ExtraWheel
        ...
        <Select
          ...
          options={
            this.props.store.enigmaModel === "M4" ? UKW_M4_Options : UKWOptions
          }
        />
        <hr />
        <Form>
          <div key="custom-checkbox" className="settingsAreLocked mb-3">
            <Form.Check
              custom
              checked={this.props.store.settingsAreLocked}
              type="checkbox"
              id="custom-checkbox"
              label={
            ...
            {this.props.store.settingsAreLocked === false ? (
              <div
